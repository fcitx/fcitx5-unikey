...
constexpr UkEventLabelPair UkEvLabelList[] = {{"Tone0", vneTone0},
                                              {"Tone1", vneTone1},
                                              {"Tone2", vneTone2},
                                              {"Tone3", vneTone3},
                                              {"Tone4", vneTone4},
                                              ...
                                              {"Telex-W", vne_telex_w},
                                              {"Escape", vneEscChar},
                                              {"DD", (int)vneCount + vnl_DD},
                                              {"dd", (int)vneCount + vnl_dd},
                                              {"A^", (int)vneCount + vnl_Ar},
                                              {"a^", (int)vneCount + vnl_ar},
                                              {"A(", (int)vneCount + vnl_Ab},
                                              {"a(", (int)vneCount + vnl_ab},
                                              {"E^", (int)vneCount + vnl_Er},
                                              {"e^", (int)vneCount + vnl_er},
                                              {"O^", (int)vneCount + vnl_Or},
                                              {"o^", (int)vneCount + vnl_or},
                                              {"O+", (int)vneCount + vnl_Oh},
                                              {"o+", (int)vneCount + vnl_oh},
                                              {"U+", (int)vneCount + vnl_Uh},
                                              {"u+", (int)vneCount + vnl_uh}};
